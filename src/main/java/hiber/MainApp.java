...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carrService.add(new Car("Mazda", 1));
      carrService.add(new Car("BMW", 2));
      carrService.add(new Car("Mitsubishi", 3));
      carrService.add(new Car("Mercedes-Benz", 4));
      ...
      userService.getUsersByModelAndSeries("BMW",2);
